...
// Generated functions for use within plugin Graphics Library
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_GLIB)
#define emberAfPluginGlibPrint(...) emberAfPrint(EMBER_AF_PRINT_PLUGIN_GLIB, __VA_ARGS__)
#define emberAfPluginGlibPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PLUGIN_GLIB,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPluginGlibFlush()
#define emberAfPluginGlibDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PLUGIN_GLIB) ) { x; }
#define emberAfPluginGlibPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PLUGIN_GLIB, (buffer), (len), (withSpace))
#define emberAfPluginGlibPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PLUGIN_GLIB, (buffer))
#else
#define emberAfPluginGlibPrint(...)
#define emberAfPluginGlibPrintln(...)
#define emberAfPluginGlibFlush()
#define emberAfPluginGlibDebugExec(x)
#define emberAfPluginGlibPrintBuffer(buffer, len, withSpace)
#define emberAfPluginGlibPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PLUGIN_GLIB)
