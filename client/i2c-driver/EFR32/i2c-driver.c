...
#include "../efr32_inc/i2c-driver.h"

//#include "i2cspmconfig.h"
#include "em_gpio.h"
#include "../efr32_inc/em_i2c.h"
...
uint8_t halI2cWriteWriteReg(uint8_t address,
                         ...
                         uint8_t count)
{
  ...
  seq.buf[0].data = (uint8_t*)buffer[0];
  seq.buf[0].data = (uint8_t*)buffer[1];
