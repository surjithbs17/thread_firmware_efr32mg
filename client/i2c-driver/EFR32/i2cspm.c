...
void I2CSPM_Init(I2CSPM_Init_TypeDef *init)
{
  ...
  //init->port->ROUTELOC0 = (init->portLocationSda << _I2C_ROUTELOC0_SDALOC_SHIFT) | (init->portLocationScl << _I2C_ROUTELOC0_SCLLOC_SHIFT);
  init->port->ROUTELOC0 = (init->portLocationSda | _I2C_ROUTELOC0_SDALOC_LOC16) | ((init->portLocationScl |_I2C_ROUTELOC0_SCLLOC_LOC14<< _I2C_ROUTELOC0_SCLLOC_SHIFT));
#else
